  ...
  return (
    ...
    <div className='bg-black min-h-screen text-white'>
      ...
      <div className="w-full sm:w-1/3">
          <button className='w-full bg-indigo-600 text-white py-4 rounded-xl text-lg font-semibold hover:bg-indigo-700 hover:scale-105 transition-transform duration-200 shadow-md' onClick={tabswitchseasonal}>Seasonal</button>
          </div>
            <div className="w-full sm:w-1/3">
         ...
         {tab===1 && <SeasonalAnime/>}
         {tab===0 && <RandomAnime key={random?.mal_id} random={random} loading={loading}/>}
         {tab===2 && <TopAnime/>}
         <FootComponent/>
